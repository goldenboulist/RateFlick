  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        <Link to="/" className="interactive text-2xl font-bold tracking-tight text-[var(--fg)] hover:opacity-80">
          RateFlick
        </Link>
      </div>
      <div className="flex flex-wrap items-center gap-3">
        <ThemeSelector value={theme} onChange={onThemeChange} />
        <Link to="/profile" className="interactive flex items-center gap-2 rounded-full border border-[var(--border)] bg-[var(--card)] py-1 pl-1 pr-2 shadow-sm hover:border-[var(--muted)]/40 hover:shadow-md">
          <span
